defmodule Babysitting.EmailView do
  ...
  def click(title, url) do
    Phoenix.HTML.raw "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\" style=\"border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;\" width=\"100%\">
      <tbody>
        <tr>
  ...
  def paragraph(content) do
    Phoenix.HTML.raw "<p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;\">#{content}</p>"
  end
end
